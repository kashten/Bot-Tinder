...
class TinderBot():
    ...
    def login (self):
        ...
        #location_btn = self.driver.find_element_by_xpath ('//*[@id="modal-manager"]/div/div/div/div/div[3]/button[1]/span')
        #location_btn.click()                     
        ...
        email_in.send_keys('xxxxx@gmail.com') #enter facebook email 

        pw_in = self.driver.find_element_by_xpath('//*[@id="pass"]')
        pw_in.send_keys('xxxxxxxx') #enter facebook password
